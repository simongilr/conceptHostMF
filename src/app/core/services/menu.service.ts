...
export class MenuService {
    ...
    clickApp: number = 0;
    microfrontends = [
      { id: 1, name: 'SICOF', url: 'http://localhost:4800/', classStyle: 'margin-top: -18px; width: calc(98.8vw + 28px); margin-left: -28px; height: 100vh; border: none; overflow-x: hidden !important;  overflow: hidden !important;',  icon: 'paper-plane-outline', colorIcon: 'warning'},
